...
class AnalysisAnswerRepository:
    ...
    async def list_by_project(
        ...
        protocol_q_ids = select(PromptQuestion.id).where(
            PromptQuestion.category == "Protocol_decision"
        )
        result = await self.db.execute(
            ...
            .where(
                and_(
                    ...
                    AnalysisAnswer.question_id.in_(protocol_q_ids),
                )
            )
